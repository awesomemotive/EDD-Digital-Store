...
<section id="main" role="main">
            ...
            <?php if ( have_posts() ) : ?>
                ...
                <header class="page-header">
                    <h1 class="page-title"><?php
                        printf( __( 'Category: <span class="current">%s</span>', 'edd-digitalstore' ), '<span>' . single_cat_title( '', false ) . '</span>' );
                    ?></h1><!-- .page-title -->
            ...
            <?php else: ?>
                ...
                <div class="entry-content">
                    <p><?php _e( 'Apologies, but no results were found for the requested category. Perhaps searching will help find a related post.', 'edd-digitalstore' ); ?></p>
                    <?php get_search_form(); ?>
                </div><!-- .entry-content -->
