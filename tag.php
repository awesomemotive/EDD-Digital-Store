...
<section id="main" role="main">
        ...
        <?php if ( have_posts() ) : ?>
            ...
            <header class="page-header">
                <h1 class="page-title"><?php printf( __( 'Tag Archives: %s', 'digitalstore-mattvarone' ), '<span>' . single_tag_title( '', false ) . '</span>' ); ?></h1>
        ...
        <?php else: ?>
            ...
            <article class="post no-results not-found">
                ...
                <div class="entry-content">
                    <p><?php _e( 'Apologies, but no results were found for the requested tag. Perhaps searching will help find a related post.', 'digitalstore-mattvarone' ); ?></p>
                    <?php get_search_form(); ?>
                </div><!-- .entry-content -->
